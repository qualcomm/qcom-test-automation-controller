...
private slots:
	...
	void onFirmwareSelectionUpdated(QAbstractButton* selectedBtn);
...
protected slots:
	...
	void onNotificationStarted(const QString& message, NotificationLevel level = eWarnNotification);
	void onMetaSplitterMoved(int pos, int index);
...
private:
	...
	QList<quint32> firmwareSelection();
	void setFirmwareSelection();
	void setAboutFirmware(int fwVer);
